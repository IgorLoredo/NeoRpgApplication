...
public class BattleController {
    ...
    @PostMapping
    @Operation(summary = "Executa batalha entre dois personagens")
    @ApiResponses({
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Batalha executada",
            content = @Content(schema = @Schema(implementation = BattleResultResponse.class))),
    ...
    public ResponseEntity<ApiResponse<BattleResultResponse>> executeBattle(
        ...
        try {
            ...
            BattleResultResponse result = battleUseCase.executeBattle(command);
